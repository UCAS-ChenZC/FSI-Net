...
class CDDataAugmentation:
    ...
    #                 num_crops_x = img_width // 256
    #                 num_crops_y = img_height // 256
    #                 cropped_imgs = []
    ...
    #                         cropped_imgs.append([img.crop((left, upper, right, lower)) for img in imgs])
    #                 # Flatten the lists of cropped images and labels
    #                 imgs = [img for sublist in cropped_imgs for img in sublist]
    ...
    #                         # Crop the images and labels
    #                         # cropped_imgs.append([img.crop((left, upper, right, lower)) for img in imgs])
    #                         cropped_labels.append([label.crop((left, upper, right, lower)) for label in labels])
    #             else:
