...
def get_args():
    ...
    parser.add_argument('--checkpoint_root', default='/media/solid/PS2000/603/checkpoints/', type=str)
    parser.add_argument('--output_folder', default='Pred/cdd/511Ours', type=str)
