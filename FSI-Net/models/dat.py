...
from models.dat_blocks import *
from models.nat import NeighborhoodAttention2D
from models.slide import SlideAttention
...
class DAT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, num_classes=1000, expansion=4,
        ...
        self.patch_proj = nn.Sequential(
            nn.Conv2d(32, dim_stem // 2, 3, patch_size // 2, 1),
